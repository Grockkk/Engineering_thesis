...
class addCaloriesActivity : AppCompatActivity(), DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener  {
    ...
    private lateinit var addCalories: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addCalories = findViewById(R.id.ID_Calories)
        ...
        addBtn.setOnClickListener(){
            ...
            if(number != "" && startTime.isBefore(endTime)){
                ...
                Toast.makeText(applicationContext,"Enter calories", Toast.LENGTH_SHORT).show()
            }
        }
    ...
    fun initializeGoogle(): HealthConnectClient {
        ...
        return HealthConnectClient.getOrCreate(this@addCaloriesActivity)
    }
