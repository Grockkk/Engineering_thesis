...
class addDistanceActivity : AppCompatActivity(), DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addBtn.setOnClickListener(){
            ...
            if(number != "" && startTime.isBefore(endTime)){
                ...
                Toast.makeText(applicationContext,"enter distance", Toast.LENGTH_SHORT).show()
            }
        }
    ...
    fun initializeGoogle(): HealthConnectClient {
        ...
        return HealthConnectClient.getOrCreate(this@addDistanceActivity)
    }
